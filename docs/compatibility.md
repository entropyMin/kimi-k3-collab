...
| --- | --- | --- |
| 0.31.0 | Tested (preferred) | Real Windows session/prompt/WebSocket/result handoff plus fake protocol regression fixtures |
| 0.29.0 | Tested | Real Windows session/prompt/WebSocket/result handoff plus fake protocol regression fixtures |
